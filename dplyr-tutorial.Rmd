...
-   This is a copy from <https://github.com/justmarkham/dplyr-tutorial>
-   There is a 40-minute [video tutorial](https://www.youtube.com/watch?v=jWjqLW-u3hc) on YouTube that walks through this document in detail.
...
flights <- tibble::as_tibble(hflights)   ### I REPLACED tbl_df with as_tibble
